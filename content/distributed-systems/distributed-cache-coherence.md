...
- Send a log of changes to replicated storage. If a cache fails, read its log back from storage. This is how a backup takes over from a failed primary in [[distributed-systems/primary-backup|primary-backup replication]], by replaying the log.

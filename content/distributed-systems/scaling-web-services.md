...
Organize a complex application as a large number of independent services communicating through [[distributed-systems/RPC|RPC]], each using primary/backup or Paxos for availability and fault tolerance. Components can then be developed and scaled independently.

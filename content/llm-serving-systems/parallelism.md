...
This note lays out the three main parallelism strategies (data, pipeline, tensor), the memory accounting that motivates them, and how they compose. Parallel execution becomes necessary when the model or KV cache exceeds one device; compare the [[llm-serving-systems/memory-management|memory constraints]] and the routing-specific case in [[llm-serving-systems/mixture-of-experts|Mixture of Experts]].
...
- [[llm-serving-systems/mixture-of-experts|Mixture of Experts]]

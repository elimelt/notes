...
Covers the core of ad hoc retrieval. It works through how documents get indexed, how queries get scored against them, and how ranked results get evaluated, then ends with dense retrieval, which handles the vocabulary mismatch baked into term matching. Retrieval pipelines consume [[natural-language-processing/reading/tokenization|tokenized document representations]], and retrieval-augmented systems feed results into the [[natural-language-processing/prompting|prompting]] workflow. Follows Jurafsky & Martin, [SLP3](https://web.stanford.edu/~jurafsky/slp3/).

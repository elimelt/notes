...
- **Channel**: the medium the signal crosses. See [[networks/1-physical/media|media]].
...
Usually either the bandwidth or the delay is the bottleneck, and BD tells you the overall capacity of the pipe. It matters for [[networks/2-direct-links/retransmission|retransmission]] protocols, which must keep BD bits outstanding to use the link fully.

## Related notes

- [[networks/1-physical/media|media]]

...
Fixing this takes an explicit mechanism where the receiver tells the sender how much buffer space remains. TCP does this with the receive window, covered in [[networks/4-transport/flow-control|flow control]].

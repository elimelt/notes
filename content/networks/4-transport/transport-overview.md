...
Which one an application wants depends on whether it needs delivery guarantees more than it needs low overhead. [[networks/4-transport/TCP|TCP]] and [[networks/4-transport/UDP|UDP]] cover the two protocols.

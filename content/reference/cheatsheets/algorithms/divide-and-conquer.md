...
- **Algorithm**: $Bisect(a, b, \epsilon)$, assuming the orientation $f(a) \le 0 \le f(b)$ (flip the comparison otherwise)
...
- **Algorithm**: $f(S \in \mathbb{R}^n, k \in \mathbb{R})$
  - Select an approximate median element $w$ using the median of the $\frac{n}{5}$ medians of subarrays of size $5$

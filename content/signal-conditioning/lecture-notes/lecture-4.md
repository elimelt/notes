...
A resistor that is getting warm is leaking power. This note states the power relations and Kirchhoff's laws, works one divider example end to end, and models the iPhone standby draw from [[signal-conditioning/lecture-notes/lecture-2|lecture 2]] as a single resistor.
...
In [[signal-conditioning/lecture-notes/lecture-2|lecture 2]] we estimated that an iPhone in standby draws 7.55 mA from its 3.8 V lithium battery. Model the phone's power consumption as a single resistor across the battery:

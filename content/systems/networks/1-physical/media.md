...
The derivation is in [Shannon's 1948 paper](https://people.math.harvard.edu/~ctm/home/text/others/shannon/entropy/entropy.pdf), and [[systems/networks/0-foundation/information-theory|information theory]] unpacks the intuition. Increasing bandwidth increases capacity linearly when noise is fixed, while increasing SNR only helps logarithmically.

...
aliases:
  - operating-systems/lecture-notes/page-faults
...
Every memory access becomes two references: one to the page table and one to the actual memory. A TLB, which is a hardware cache of page table entries, absorbs most of the page table lookups. See [[systems/operating-systems/lecture-notes/tlb|translation lookaside buffers]].

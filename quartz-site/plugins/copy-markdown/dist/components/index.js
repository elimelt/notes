...
var CopyMarkdown = ((options) => {
  ...
  const Component = ({
    ...
    return /* @__PURE__ */ u2("span", { class: `${displayClass ?? ""} copy-markdown-control`, hidden: true, children: [
      /* @__PURE__ */ u2(
        "button",
        {
          ...
          children: /* @__PURE__ */ u2("span", { class: "copy-markdown-label", children: "Copy Markdown" })
        }
      ),
      /* @__PURE__ */ u2(
        "span",

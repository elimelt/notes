...
class SiteGenerator:
    ...
    def _generate_navigation(self, current_page: Page) -> str:
        ...
        # Add GitHub link with inline SVG icon
        nav_items.append(
            '<a href="https://github.com/elimelt/notes" '
            'style="display:inline-flex;align-items:center;" title="View on GitHub">'
    ...
    def _copy_themes(self) -> None:
        ...
        themes_source = Path(__file__).parent / "template" / "themes"
